...
You can play SUI 2222 at [https://ethoswallet.github.io/Sui8192](https://ethoswallet.github.io/Sui8192)

SUI 2222 consists of a smart contract that allows the player to mint a game that is playable on chain.
...
This project uses the [Ethos APIs](https://ethoswallet.xyz/developers) to make the SUI 2222 game accessible to people who do not yet have a web3 wallet. It allows them to start playing the game right away without having to figure out a wallet first.
...
The SUI 2222 smart contract is written Sui Move for deployment on the Sui blockchain. It consists of three parts:
